...
- **conformant\*:** 541 (68.6%) · structural-match: 195 → 736/789 structurally equal (93.3%)
- **Accepted deltas (documented, won't-fix):** 4 · **Tracked gaps (unaccepted, will-fix):** 233 → of 237 non-conformant graphs
...
## Tracked diverged (42) — worst-first
...
|---|---:|---|---|
| `path-structure` | 22 | `1436`, `1447`, `1718` | edge path has a different command sequence or point count — spline routing structure |

...
- **conformant\*:** 562 (71.2%) · structural-match: 179 → 741/789 structurally equal (93.9%)
- **Accepted deltas (documented, won't-fix):** 4 · **Tracked gaps (unaccepted, will-fix):** 212 → of 216 non-conformant graphs
...
## Tracked diverged (37) — worst-first
...
|---|---:|---|---|
| `path-structure` | 17 | `1436`, `1447`, `1718` | edge path has a different command sequence or point count — spline routing structure |

...
- **byte-match:** 493 (62.4%) · structural-match: 198 → 691/790 structurally equal (87.5%)
- **Accepted deltas (documented, won't-fix):** 4 · **Tracked gaps (unaccepted, will-fix):** 282 → of 286 non-byte-match graphs
...
## Tracked diverged (88) — worst-first
...
| `windows-shells` | 392.04 | `svg/g[1]/g[23]/path[1]/@d` |
...
_… and 28 more diverged inputs (see parity.json + the buckets below)._

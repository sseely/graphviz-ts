...
- **byte-match:** 278 · **structural-match:** 236 → 514/796 structurally equal (64.6%)
- **diverged:** 254 · **errored:** 5 · **timeout:** 7 · **oracle-error:** 16
...
| `share-pgram` | 1543.00 | `svg/g[1]/g[29]/path[1]/@d` |
| `windows-pgram` | 1543.00 | `svg/g[1]/g[29]/path[1]/@d` |
...
_… and 194 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 168 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |
| `element-count` | 76 | `1323`, `1323_1`, `1367` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

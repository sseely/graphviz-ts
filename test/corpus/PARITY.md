...
- **byte-match:** 364 · **structural-match:** 277 → 641/795 structurally equal (80.6%)
- **diverged:** 137 · **errored:** 6 · **timeout:** 0 · **oracle-error:** 11
...
_… and 77 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 93 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

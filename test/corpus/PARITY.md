...
- **byte-match:** 334 · **structural-match:** 252 → 586/795 structurally equal (73.7%)
- **diverged:** 188 · **errored:** 5 · **timeout:** 5 · **oracle-error:** 11
...
## diverged (188) — worst-first

| id | maxDelta | firstDiffPath |
|---|---:|---|
| `2470` | 38483.47 | `svg/g[1]/g[231]/path[1]/@d` |
| `1879` | 23829.52 | `svg/g[1]/g[99]/g[1]/a[1][childCount]` |
| `2471` | 23020.00 | `svg/g[1][childCount]` |
...
| `1332` | 2120.41 | `svg/g[1]/g[72]/path[1]/@d` |
| `42` | 1933.77 | `svg/g[1]/g[1]/@class` |
| `graphs-NaN` | 1906.99 | `svg/g[1]/g[3]/path[1]/@d` |
| `share-NaN` | 1906.99 | `svg/g[1]/g[3]/path[1]/@d` |
| `windows-NaN` | 1906.99 | `svg/g[1]/g[3]/path[1]/@d` |
...
| `graphs-rowe` | 672.07 | `svg/g[1]/g[8]/path[1]/@d` |
| `share-rowe` | 672.07 | `svg/g[1]/g[8]/path[1]/@d` |
| `windows-rowe` | 672.07 | `svg/g[1]/g[8]/path[1]/@d` |
| `graphs-big` | 650.92 | `svg/g[1]/g[5]/path[1]/@d` |
| `graphs-b57` | 605.78 | `svg/g[1]/g[39]/path[1]/@d` |
| `2592` | 585.00 | `svg/g[1]/g[4]/@id` |

_… and 128 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 126 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

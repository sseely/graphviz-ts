...
- **byte-match:** 146 · **structural-match:** 238 → 384/796 structurally equal (48.2%)
- **diverged:** 369 · **errored:** 20 · **timeout:** 7 · **oracle-error:** 16
...
_… and 309 more diverged inputs (see parity.json + the buckets below)._
...
| `element-count` | 132 | `1323`, `1323_1`, `1436` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

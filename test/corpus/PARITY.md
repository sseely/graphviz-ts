...
- **byte-match:** 302 · **structural-match:** 265 → 567/796 structurally equal (71.2%)
- **diverged:** 201 · **errored:** 5 · **timeout:** 7 · **oracle-error:** 16
...
| `graphs-b102` | 1850.69 | `svg/g[1]/g[153]/path[1]/@d` |
...
_… and 141 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 129 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

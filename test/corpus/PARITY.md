...
- **byte-match:** 489 · **structural-match:** 198 → 687/790 structurally equal (87.0%)
- **diverged:** 92 · **errored:** 0 · **timeout:** 0 · **oracle-error:** 11
...
_… and 32 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 71 | `1213-1`, `1213-2`, `1436` | edge path has a different command sequence or point count — spline routing structure |

...
- **byte-match:** 378 · **structural-match:** 278 → 656/790 structurally equal (83.0%)
- **diverged:** 123 · **errored:** 0 · **timeout:** 0 · **oracle-error:** 11
...
_… and 63 more diverged inputs (see parity.json + the buckets below)._
...
| `element-count` | 31 | `1323`, `1323_1`, `1367` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

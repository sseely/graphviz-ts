...
- **byte-match:** 337 · **structural-match:** 265 → 602/795 structurally equal (75.7%)
- **diverged:** 172 · **errored:** 5 · **timeout:** 5 · **oracle-error:** 11
...
|---|---:|---|---|
| `path-structure` | 110 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

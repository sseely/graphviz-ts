...
- **byte-match:** 344 · **structural-match:** 262 → 606/795 structurally equal (76.2%)
- **diverged:** 168 · **errored:** 6 · **timeout:** 4 · **oracle-error:** 11
...
| `1436` | 2221.78 | `svg/g[1]/g[11]/path[1]/@d` |
...
| `1435` | 430.00 | `svg/g[1][childCount]` |
| `2619_2` | 412.00 | `svg/g[1]/g[1]/g[1]/a[1][childCount]` |
| `graphs-b53` | 395.08 | `svg/g[1]/g[11]/path[1]/@d` |
...
_… and 108 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 108 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |
| `element-count` | 53 | `1323`, `1323_1`, `1367` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

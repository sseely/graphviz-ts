...
- **conformant\*:** 539 (68.3%) · structural-match: 194 → 733/789 structurally equal (92.9%)
- **Accepted deltas (documented, won't-fix):** 4 · **Tracked gaps (unaccepted, will-fix):** 235 → of 239 non-conformant graphs
...
## Tracked diverged (45) — worst-first

| id | maxDelta | firstDiffPath |
|---|---:|---|
| `2470` | 6967.87 | `svg/g[1]/g[351]/path[1]/@d` |
| `2239` | 5286.67 | `svg/g[1]/g[2][childCount]` |
| `2471` | 3820.60 | `svg/g[1][childCount]` |
...
| `1213-2` | 21.84 | `svg/g[1]/g[11]/path[1]/@d` |
| `nshare-root_circo` | 21.00 | `svg/g[1]/g[1313]/path[1]/@d` |
| `nshare-root_twopi` | 21.00 | `svg/g[1]/g[1313]/path[1]/@d` |
| `1213-1` | 20.01 | `svg/g[1]/g[10]/path[1]/@d` |
...
|---|---:|---|---|
| `path-structure` | 25 | `1213-1`, `1213-2`, `1436` | edge path has a different command sequence or point count — spline routing structure |

...
- **byte-match:** 325 · **structural-match:** 253 → 578/795 structurally equal (72.7%)
- **diverged:** 196 · **errored:** 5 · **timeout:** 5 · **oracle-error:** 11
...
_… and 136 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 134 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

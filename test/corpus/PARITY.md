...
- **byte-match:** 486 · **structural-match:** 198 → 684/790 structurally equal (86.6%)
- **diverged:** 95 · **errored:** 0 · **timeout:** 0 · **oracle-error:** 11
...
_… and 35 more diverged inputs (see parity.json + the buckets below)._
...
| `element-count` | 20 | `1332`, `1367`, `1435` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

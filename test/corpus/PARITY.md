...
- **byte-match:** 280 · **structural-match:** 237 → 517/796 structurally equal (64.9%)
- **diverged:** 251 · **errored:** 5 · **timeout:** 7 · **oracle-error:** 16
...
_… and 191 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 179 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

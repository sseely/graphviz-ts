...
- **byte-match:** 338 · **structural-match:** 265 → 603/795 structurally equal (75.8%)
- **diverged:** 171 · **errored:** 5 · **timeout:** 5 · **oracle-error:** 11
...
_… and 111 more diverged inputs (see parity.json + the buckets below)._
...
| `element-count` | 56 | `1323`, `1323_1`, `1367` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

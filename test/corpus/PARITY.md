...
- **byte-match:** 363 · **structural-match:** 271 → 634/795 structurally equal (79.7%)
- **diverged:** 143 · **errored:** 6 · **timeout:** 0 · **oracle-error:** 12
...
## diverged (143) — worst-first

| id | maxDelta | firstDiffPath |
|---|---:|---|
| `2371` | 12524.69 | `svg/g[1]/g[71]/path[1]/@d` |
...
| `2095_1` | 1315.91 | `svg/g[1]/g[130]/path[1]/@d` |
...
_… and 83 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 99 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

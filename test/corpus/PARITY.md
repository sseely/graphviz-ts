...
- **byte-match:** 454 · **structural-match:** 227 → 681/790 structurally equal (86.2%)
- **diverged:** 98 · **errored:** 0 · **timeout:** 0 · **oracle-error:** 11
...
_… and 38 more diverged inputs (see parity.json + the buckets below)._
...
| `element-count` | 22 | `1332`, `1367`, `1435` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

...
- **byte-match:** 162 · **structural-match:** 250 → 412/796 structurally equal (51.8%)
- **diverged:** 343 · **errored:** 20 · **timeout:** 6 · **oracle-error:** 15
...
_… and 283 more diverged inputs (see parity.json + the buckets below)._
...
| `element-count` | 130 | `1323`, `1323_1`, `1436` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

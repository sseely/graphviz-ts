...
- **byte-match:** 487 · **structural-match:** 198 → 685/790 structurally equal (86.7%)
- **diverged:** 94 · **errored:** 0 · **timeout:** 0 · **oracle-error:** 11
...
_… and 34 more diverged inputs (see parity.json + the buckets below)._
...
| `element-count` | 19 | `1332`, `1367`, `1435` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

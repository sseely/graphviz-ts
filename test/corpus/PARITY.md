...
- **byte-match:** 297 · **structural-match:** 263 → 560/796 structurally equal (70.4%)
- **diverged:** 208 · **errored:** 5 · **timeout:** 7 · **oracle-error:** 16
...
| `linux.x86-root_circo` | 8110.20 | `svg/g[1]/g[5]/path[1]/@d` |
| `linux.x86-root_twopi` | 8110.20 | `svg/g[1]/g[5]/path[1]/@d` |
| `2620` | 8076.40 | `svg/g[1]/g[25]/path[1]/@d` |
| `2239` | 7556.15 | `svg/g[1]/g[2][childCount]` |
| `nshare-root_circo` | 5403.60 | `svg/g[1]/g[5]/path[1]/@d` |
| `nshare-root_twopi` | 5403.60 | `svg/g[1]/g[5]/path[1]/@d` |
| `graphs-root` | 3674.00 | `svg/g[1]/g[7]/path[1]/@d` |
| `1447_1` | 3612.38 | `svg/g[1]/g[27]/path[1]/@d` |
| `graphs-b103` | 3569.40 | `svg/g[1]/g[70]/path[1]/@d` |
...
| `windows-b106` | 1289.25 | `svg/g[1]/g[10]/path[1]/@d` |
...
| `graphs-b106` | 761.86 | `svg/g[1]/g[10]/path[1]/@d` |
...
_… and 148 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 136 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

...
- **byte-match:** 149 · **structural-match:** 238 → 387/796 structurally equal (48.6%)
- **diverged:** 366 · **errored:** 20 · **timeout:** 7 · **oracle-error:** 16
...
_… and 306 more diverged inputs (see parity.json + the buckets below)._
...
| `element-count` | 129 | `1323`, `1323_1`, `1436` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |

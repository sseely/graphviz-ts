...
|---|---:|---|---|
| `path-structure` | 133 | `1213-1`, `1213-2`, `1447` | edge path has a different command sequence or point count — spline routing structure |
...
| `color-stroke` | 29 | `1408`, `1896`, `2082` | fill/stroke value differs — color resolution or default styling |

...
- **byte-match:** 167 · **structural-match:** 252 → 419/796 structurally equal (52.6%)
- **diverged:** 336 · **errored:** 20 · **timeout:** 6 · **oracle-error:** 15
...
_… and 276 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 138 | `1213-1`, `1213-2`, `1447` | edge path has a different command sequence or point count — spline routing structure |
| `element-count` | 130 | `1323`, `1323_1`, `1435` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |
| `attr-or-tag` | 36 | `1447_1`, `1453`, `1622_0` | element tag or a non-coordinate attribute differs |
| `color-stroke` | 21 | `1408`, `1896`, `2082` | fill/stroke value differs — color resolution or default styling |

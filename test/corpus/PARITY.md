...
- **byte-match:** 172 · **structural-match:** 255 → 427/796 structurally equal (53.6%)
- **diverged:** 328 · **errored:** 20 · **timeout:** 6 · **oracle-error:** 15
...
_… and 268 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 150 | `1213-1`, `1213-2`, `1447` | edge path has a different command sequence or point count — spline routing structure |
| `element-count` | 124 | `1323`, `1323_1`, `1435` | missing/extra SVG elements — node, edge, cluster box, or arrowhead count differs |
| `attr-or-tag` | 28 | `1408`, `1447_1`, `1453` | element tag or a non-coordinate attribute differs |
| `color-stroke` | 15 | `1896`, `2082`, `2193` | fill/stroke value differs — color resolution or default styling |

...
- **byte-match:** 280 · **structural-match:** 236 → 516/796 structurally equal (64.8%)
- **diverged:** 252 · **errored:** 5 · **timeout:** 7 · **oracle-error:** 16
...
| `graphs-xx` | 1558.39 | `svg/g[1]/g[17]/path[1]/@d` |
...
| `linux.x86-neatosplines_neato` | 852.31 | `svg/g[1]/g[5]/path[1]/@d` |
| `linux.x86-overlap_neato` | 852.31 | `svg/g[1]/g[5]/path[1]/@d` |
| `linux.x86-overlap_neato1` | 852.31 | `svg/g[1]/g[5]/path[1]/@d` |
| `nshare-overlap_neato1` | 852.31 | `svg/g[1]/g[5]/path[1]/@d` |
| `2592` | 749.00 | `svg/g[1]/g[4]/@id` |
| `graphs-pgram` | 738.34 | `svg/g[1]/g[32]/path[1]/@d` |
| `graphs-jsort` | 737.20 | `svg/g[1]/g[13]/path[1]/@d` |

_… and 192 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 180 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

...
- **byte-match:** 364 · **structural-match:** 271 → 635/795 structurally equal (79.9%)
- **diverged:** 142 · **errored:** 6 · **timeout:** 0 · **oracle-error:** 12
...
## diverged (142) — worst-first

| id | maxDelta | firstDiffPath |
|---|---:|---|
| `2471` | 12463.00 | `svg/g[1][childCount]` |
...
_… and 82 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 98 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

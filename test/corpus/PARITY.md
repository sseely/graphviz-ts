...
- **byte-match:** 316 · **structural-match:** 261 → 577/795 structurally equal (72.6%)
- **diverged:** 197 · **errored:** 5 · **timeout:** 5 · **oracle-error:** 11
...
_… and 137 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 135 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

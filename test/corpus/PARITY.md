...
- **byte-match:** 362 · **structural-match:** 265 → 627/795 structurally equal (78.9%)
- **diverged:** 150 · **errored:** 6 · **timeout:** 0 · **oracle-error:** 12
...
| `2095_1` | 6793.60 | `svg/g[1]/g[130]/path[1]/@d` |
...
_… and 90 more diverged inputs (see parity.json + the buckets below)._
...
|---|---:|---|---|
| `path-structure` | 106 | `1213-1`, `1213-2`, `1332` | edge path has a different command sequence or point count — spline routing structure |

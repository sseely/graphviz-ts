...
| `share-b29` | 3 | A9 | 2 draw-op diffs; mirror of linux.i386-b29 (label anchor 841.06 vs 878.28) — same placeLabels knife-edge tie; edge spline + arrowhead bit-identical, all other labels match. | known-divergences.md#a9-engine-track-twopi-circo |

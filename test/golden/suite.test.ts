...
// ---------------------------------------------------------------------------
// Suite-level check: manifest must have exactly 97 entries
// (82 baseline + 15 render-styling goldens, mission parity-render-styling)
// ---------------------------------------------------------------------------

test('manifest has 97 entries', () => {

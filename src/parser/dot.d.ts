...
export type StartRuleNames = "Graph";
export interface ParseOptions<T extends StartRuleNames = "Graph"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Graph">>(
  input: string,
  options?: Options,
): any;

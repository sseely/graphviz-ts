...
import type { NodeAlgData } from './algData.js';

// Per-engine ND_alg data types live in ./algData.js (split out to keep this
// file under the size cap). Re-exported here so existing importers of
// './nodeInfo.js' continue to resolve them unchanged.
export type {
  DotAlgData, NeatoAlgData, FdpAlgData, FdpDndata, CircoNData, CircoCData,
  TwopiAlgData, OsageAlgData, PatchworkAlgData, NodeAlgData,
} from './algData.js';
export { THETA_UNSET } from './algData.js';
...
export function makeNodeInfo(): NodeInfo {
  // C agbindrec calloc-zeroes the WHOLE Agnodeinfo_t struct, so every ND_*
  // field exists from creation at a fixed offset. The port mirrors that:
  // pre-declaring EVERY optional field (value-preserving `undefined` — same
  // semantics as absent under the `?? 0`/truthy accessors) pins a single V8
  // hidden class for all NodeInfo objects. Without this, fields added lazily
  // during layout (par/low/lim/rank/tree_in/tree_out/...) drove NodeInfo into
  ...
  return {
    ...
    base_width: undefined, base_height: undefined, label: undefined, xlabel: undefined,
    shape: undefined, shape_info: undefined, rank: undefined, order: undefined,
    rankIsXCoord: undefined, mval: undefined, node_type: undefined, ranktype: undefined,
    weight_class: undefined, mark: undefined, onstack: undefined, has_port: undefined,
    showboxes: undefined, in: undefined, out: undefined, flat_in: undefined,
    flat_out: undefined, other: undefined, save_in: undefined, save_out: undefined,
    tree_in: undefined, tree_out: undefined, next: undefined, prev: undefined,
    par: undefined, low: undefined, lim: undefined, priority: undefined,
    UF_size: undefined, UF_parent: undefined, rep: undefined, set: undefined,
    clust: undefined, posAlg: undefined, pinned: undefined, id: undefined,
    heapindex: undefined, hops: undefined, pos: undefined, dist: undefined, alg: undefined,
  };
}

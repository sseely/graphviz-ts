...
/**
 * Layout-engine algorithm data stored in ND_alg for the circo engine.
 *
 * @see lib/circogen/ — circo-engine algorithm data
 */
export interface CircoAlgData {
  readonly kind: 'circo';
}

/**
 * Layout-engine algorithm data stored in ND_alg for the twopi engine.
 *
 * @see lib/twopigen/ — twopi-engine algorithm data
 */
 ...
 *
 * @see lib/osage/ — osage-engine algorithm data
 */

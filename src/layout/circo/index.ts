 ...
 *   1. circoInitGraph  — allocate ndata
 *   2. circoLayout     — biconn + circle layout
 *   3. freeNData       — null alg on first node (shared ndata block GC'd)
 *   4. (spline routing — handled by caller / renderer)
 *   5. dotneato_postprocess — handled by caller / renderer
 *

...
|----|-------------|-------|--------|-----------|------|
| T6.1 | Consolidate registry, regen docs, full cross-engine sweep | general-purpose | accept registry, test/corpus/parity-*.{json,jsonl}, PARITY*.md, attribution-sfdp.jsonl, decision-journal | T1-T5 | [ ] |

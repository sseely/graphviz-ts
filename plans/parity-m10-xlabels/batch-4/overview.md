...
|----|-------------|-------|--------|------------|------|
| T4 | xlabels.c placeLabels port ([T4-xlabels.md](T4-xlabels.md)) | sonnet | src/label/xlabels.ts (new), src/label/xlabels.test.ts (new), src/cdt/* (AD4 conditional, minimal) | T3 | [ ] |
| T5 | addXLabels + helpers in postproc; EdgeLabelsDone wiring ([T5-addxlabels.md](T5-addxlabels.md)) | sonnet | src/common/postproc.ts, src/layout/dot/splines.ts, src/common/postproc.test.ts, src/model/graphInfo.ts (field only) | T3 (header contract only) | [ ] |

...
|----|-------------|-------|--------|------------|------|
| T2 | node.c + split.q.c port ([T2-node-splitq.md](T2-node-splitq.md)) | sonnet | src/label/node.ts (new), src/label/split-q.ts (new), src/label/node-splitq.test.ts (new) | T1 | [x] |

...
278 existing conforms to.

| ID | Description | Agent | Writes | Depends On | Done |
|----|-------------|-------|--------|-----------|------|
| T3 | Re-run survey + dashboard; verify 6 rankdir rows improved, conformant ≥ 278, 0 regressions; record residual `ratio=` notes | sonnet | `test/corpus/parity.json`, `test/corpus/PARITY.md` | T1, T2 | [x] |

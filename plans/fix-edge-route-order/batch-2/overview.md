...
| T2.2 | Refresh `parity.json` (pango/LUT baseline) + `parity-rules.json` + `PARITY.md`; write comparison page; close mission summary | sonnet | `test/corpus/parity.json`, `test/corpus/parity-rules.json`, `test/corpus/PARITY.md`, `README.md` (summary) | T2.1 | [x] |

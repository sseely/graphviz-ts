...
| [T0.2 headless rules corpus](T0.2-headless-corpus.md) | test/corpus/* (new) | reference vs headless conformant (modulo pre-existing) |

Gate to exit Batch 0: rules survey conformant except documented pre-existing

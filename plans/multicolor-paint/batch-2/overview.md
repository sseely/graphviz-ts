...
|----|-------------|-------|--------|------------|------|
| S1 | striped + wedged node fills ([S1-striped-wedged.md](S1-striped-wedged.md)) | sonnet | src/render/svg-multicolor.ts (new), src/common/poly-gencode.ts (+tests) | G1 (parser) | [ ] |

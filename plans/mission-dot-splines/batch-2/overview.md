...
|----|-------------|-------|--------|------------|------|
| T2 | Route adjacent-rank plain forward edges via the faithful path; fix golden deltas; pin fan-out/fan-in oracles | opus | `src/layout/dot/edge-route.ts`, `src/layout/dot/edge-route-faithful.ts`, `src/layout/dot/edge-route-splines.test.ts` (new) | T1 | [ ] |

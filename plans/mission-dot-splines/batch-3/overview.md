...
|----|-------------|-------|--------|------------|------|
| T3 | Route plain multi-rank forward edges via the faithful chain path; fix golden deltas; pin long-span oracles | opus | `src/layout/dot/edge-route.ts`, `src/layout/dot/edge-route-chain.ts`, `src/layout/dot/edge-route-splines.test.ts` | T2 | [ ] |

...
| 2026-06-17 | B2-T1 | Committed faithful port of mincross.c:723 Verbose print as setMincrossTrace hook (default null). Enables C<->TS trajectory diff. Goldens byte-identical (1867). | — |
| 2026-06-17 | B2-T2 | **Trajectory diff: ROOT CAUSE FOUND — it's NOT mincross.** 2471 root mincross entry: C=23 ranks/3213 vnodes/cur=2629070 vs TS=31 ranks/2197 vnodes/cur=100010. Structural (build/rank), not transpose. ncross+transpose confirmed correct: repro2 (HTML+cluster+RL) trajectory byte-identical C↔TS through 2 invocations. | C+TS STATS probe at mincross entry (both reverted after) |

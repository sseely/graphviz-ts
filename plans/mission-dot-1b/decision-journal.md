...
| T1 | 2026-06-17 | **Gate PASS: 1812 passed / 0 failed (1810 baseline + 2 T1 tests), 115 goldens conformant, tsc 0, lizard clean.** | AD-3 invariant held — zero golden churn. | No |
...
| T4 | 2026-06-17 | **Gate PASS: 1814 passed / 0 failed, 115 goldens conformant, tsc 0, lizard clean.** No live ref to any deleted symbol (grep-verified). | AD-3 invariant held — zero golden churn. | No |
...
## T2 spike — TS conformant proof (2026-06-17)
...
- `dot-multi-edge` + `mc-edge-multicolor` goldens: conformant.
...
2. **AC4 spacing is a stale fitter-era expectation.** `multi-edge.test.ts` AC4
   ...
   the conformant `dot-multi-edge` golden proves the faithful 3-parallel

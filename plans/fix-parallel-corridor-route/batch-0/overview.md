...
| T0.3 | Pin root cause(s); confirm fix is contained to dispatch/route/box/straight-edges (NOT pathplan); write GO/STOP + refined Batch-1 task split | opus | `comparisons/root-cause.md`, `decision-journal.md` | T0.2 | [x] GO |

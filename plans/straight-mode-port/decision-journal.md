...
| T3 | gate | PASS | Regenerated parity dashboard (survey 805 inputs). vs HEAD committed parity.json: IMPROVED 14, REGRESSED 0. Tally byte-match 160->162, structural 237->250, diverged 356->343, timeout 8->6. Full vitest 2013 pass; tsc clean; git diff = write-set only. |
...
- **Parity gain:** 14 ids improved (p2 -> byte-match; 13 -> structural-match),
  0 regressions. byte-match 160->162, diverged 356->343, timeout 8->6.

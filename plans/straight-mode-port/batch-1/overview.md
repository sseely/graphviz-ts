...
| T2a | Refactor chain routing into `routeChainSegmented` (single-segment, conformant) | implementation | `src/layout/dot/edge-route-chain.ts` | — | [x] |
...
for T2a a **conformant** parity check vs baseline (no verdict changes at all).

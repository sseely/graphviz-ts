...
| T4 | Validate full survey; assert 2368 byte-match (or documented residual) + 0 regressions; refresh baseline | debugger | `test/corpus/parity.json`, `test/corpus/parity-rules.json`, `test/corpus/PARITY.md` | T3 | [x] |
...
node x now byte-match C; survey 0 regressions.

# T13 — 2361+1856 outcome (from analysis/ortho-tiebreak.md)
model: opus+sonnet · needs: the paired Batch-1 diagnosis

## Task
Read analysis/ortho-tiebreak.md. verdict=fix → implement exactly at the stated origin

# T17 — 2646 outcome (from analysis/2646-recordport.md)
model: sonnet · needs: the paired Batch-1 diagnosis

## Task
Read analysis/2646-recordport.md. verdict=fix → implement exactly at the stated origin

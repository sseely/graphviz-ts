...
|---|---|---|---|---|---|
| T3 | Faithful fix at pinned origin + regression test | main loop | sameport.ts and/or splines-path-begin/end.ts + test | T1 | [ ] |
| T4 | FlightToHover fix if bounded, else D4 disposition | main loop | (from T2) or comparisons/ page | T2 | [ ] |

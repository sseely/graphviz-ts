...
|---|---|---|---|---|---|
| T1 | UTF-8-byte iteration helper; apply to `estimate_text_width_1pt` + `freetypeHintedWidth`; unit tests (CJK/Cyrillic/Latin-1) + verify japanese & Latin1 widths vs oracle ±0.01 | debugger | `src/common/textmeasure.ts`, `src/common/textmeasure.test.ts` | — | [x] |

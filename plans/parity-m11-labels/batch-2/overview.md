...
|----|-------------|-------|--------|------------|------|
| T4 | node-xlabel + graph-label live emission ([T4-emission.md](T4-emission.md)) | sonnet | src/gvc/device.ts (+ test) | T1, T3 | [ ] |
| T5 | C-oracle verification + dotsplines/addLabelBB gap-fill ([T5-verify-gaps.md](T5-verify-gaps.md)) | sonnet | CONDITIONAL: src/layout/dot/splines*.ts, bb module; .probes/* | T1, T2, T3 | [ ] |

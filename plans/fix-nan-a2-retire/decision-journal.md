...
| 2026-07-01 | B3/T5 | C tree pristine + oracle byte-verified. Full survey: 789 ids — conformant 588, structural-match 163, diverged 26, oracle-error 12 (known noise). rules-gate: PASS, 0 regressions, 0 clip regressions. |
| 2026-07-01 | B3/T5 | Verdict movers, ALL improvements, all on 2-cycle/parallel-pair graphs (mechanism-consistent): NaN ×3 structural-match→conformant (D1 outcome 1); 42/clust2/ngk10_4 (+share/windows copies) structural-match→conformant; b124 ×3 diverged→structural-match. 42 has 26 two-cycles, b124 100, clust2 1, ngk10_4 a parallel pair. No maxDelta movers otherwise. |
| 2026-07-01 | B3/T5 | Stage-2: 3 NaN entries removed from accepted-divergences.json (surgical text edit, formatting preserved); §A2 rewritten as CLOSED/historical; parity-rules.json → parity.json; PARITY.md regenerated (789). |
| 2026-07-01 | B3/T5 | Push-forward (unit-test shape): two guard tests updated to their own documented conventions — accepted-divergences.test.ts graphs-NaN assertion A2→null (D1 removal makes the old assertion unsatisfiable); known-divergences-examples.test.ts NaN ids moved DIVERGENT→CONFORMANT list ("keep in sync with the doc"). Both are the guards working as designed, not weakening. |
| 2026-07-01 | B3/T5 | Final gates: tsc 0 errors; vitest 2546/2546. |

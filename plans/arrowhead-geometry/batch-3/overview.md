...
|----|-------------|--------|------------|------|
| T7 | Goldens per arrow-type group + manifest/suite | `test/golden/inputs/*`, `test/golden/refs/*`, `test/golden/manifest.json`, `test/golden/suite.test.ts` | T6 | [ ] |
| T8 | Regenerate parity, 0-regression check, finalize journal + memory | `test/corpus/parity.json`, `test/corpus/PARITY.md`, decision-journal.md, project memory | T7 | [ ] |

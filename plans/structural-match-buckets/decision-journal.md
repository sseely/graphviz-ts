...
| T5 | done | `analysis/README.md` written; coverage 163/163, unaccounted [] | Deliverable complete and linked from mission README. 76% of tracked cases → 4 known-locus fix missions; 7 accept; ~28 needs-C |

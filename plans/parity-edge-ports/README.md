...
- command: OUTDIR=/tmp/ep-x npx tsx .probes/render-all.ts + byte-diff vs pre-task baseline
  pass: existing goldens conformant (82 until T8 lands, ~92 after)
  on_fail: stop

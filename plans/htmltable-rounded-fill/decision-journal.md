...
| 2026-06-22 | T2 | Survey flipped 6 cases (+6 conformant), not the projected 5 | The 5 declared targets (grdfillcolor, grdlinear, grdlinear_angle, grdradial, grdradial_angle) flipped diverged→conformant, **plus** a bonus `graphs-rd_rules` (a rounded HTML-table case the same change fixes — confirmed rounded + 0 content-diff vs oracle). **Zero regressions**; all 6 grd* controls stayed conformant. Parity totals conformant 266→272, structural 232→232, diverged 270→264. |

...
|----|-------------|-------|--------|------------|------|
| T1 | Pin pack-branch wiring (initSubg need, ccomps aliasing, doSplines/mode, cluster carry) + find a clustered multi-component oracle | debugger (Sonnet) | `plans/fix-pack-dot-2458/comparisons/T1-investigation.md` | — | [ ] |

...
|----|-------------|-------|--------|------------|------|
| T2 | doDot wrapper + ccomps→per-component dotLayoutPipeline→packSubgraphs; initSubg per T1; ratio guard; 2458 golden+unit test | (inline / general) | `src/layout/dot/index.ts`, `src/layout/dot/pack-components.ts`, `src/layout/dot/pack-components.test.ts`, `test/golden/inputs/pack-2458.dot`, `test/golden/refs/pack-2458.svg` | T1 | [x] |

...
|----|-------------|-------|--------|-----------|------|
| TF.1 | Consolidate registry, regen docs, full sweep | general-purpose | accept registry, test/corpus/parity-*.{json,jsonl}, PARITY*.md, attribution-fdp.jsonl, decision-journal | 1-3 | [ ] |

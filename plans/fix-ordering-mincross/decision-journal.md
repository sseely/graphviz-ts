...
- **Result:** Survey GATE PASS, **0 regressions / 0 clip-regressions**. `graphs-in`
  structural-match → byte-match (byte-match 492→493). All 2474 prior unit tests pass.

...
| T2 | Isolated render worker + survey runner; classify byte/structural/diverged/errored/timeout; emit `parity.json` | opus | `test/corpus/render-one.ts`, `test/corpus/survey.ts` | T1 | [ ] |
